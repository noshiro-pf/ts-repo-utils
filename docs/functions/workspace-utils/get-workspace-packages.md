...
> **executeParallel**(`packages`, `scriptName`, `concurrency`): `Promise`\<readonly `object`[]\>

Defined in: [src/functions/workspace-utils/get-workspace-packages.mts:239](https://github.com/noshiro-pf/ts-repo-utils/blob/main/src/functions/workspace-utils/get-workspace-packages.mts#L239)
...
Defined in: [src/functions/workspace-utils/get-workspace-packages.mts:296](https://github.com/noshiro-pf/ts-repo-utils/blob/main/src/functions/workspace-utils/get-workspace-packages.mts#L296)
...
Defined in: [src/functions/workspace-utils/get-workspace-packages.mts:29](https://github.com/noshiro-pf/ts-repo-utils/blob/main/src/functions/workspace-utils/get-workspace-packages.mts#L29)
