...
### runCmdInStagesWorkspaces()

> **runCmdInStagesWorkspaces**(`options`): `Promise`\<`void`\>
...
Executes a npm script command across workspace packages in dependency order stages.
